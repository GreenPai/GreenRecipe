...
body { 
 ...
 .border-image {
  ...
  .review-div {
    ...
    justify-content: center;
    align-items: center;
    height: 15vh; /* 화면 높이의 100%로 div를 가득 채우도록 설정합니다. */
  }
...
function newTabClick() {
	//open한 새창을 변수 저장
	myWindow = window.open("/Cook/Review", '별점리뷰', 'width=700px,height=800px,scrollbars=yes');
}
</script>
<script>
...
<body>
   ...
   <div class="container mt-5 rounded-container">
    <div class="row">
        <div class="col-md-6">
            <img src="/img/foodimg.png" class="img-fluid border-image" alt="${recipeList[0].RCP_NM}">
        </div>
    ...
    <div class="row">
        ...
        <div id="imageContainer">
            ...
            <c:choose>
                <c:when test="${not empty recipeList[0].MANUAL01}">
                    <div style="display: flex; align-items: center; width: 100%; margin-bottom: 20px;">
                        <!-- 이미지 출력 -->
                        <img id="stepImage" src="/img/step1.png" alt="Step 1" width="150" height="100" style="float: left; margin-right: 10px; border-radius: 10px;" />
            ...
            <c:choose>
                <c:when test="${not empty recipeList[0].MANUAL02}">
                    <div style="display: flex; align-items: center; width: 100%; margin-bottom: 20px;">
                        <!-- 이미지 출력 -->
                        <img id="stepImage" src="/img/step2.png" alt="Step 2" width="150" height="100" style="float: left; margin-right: 10px; border-radius: 10px;" />
            ...
            <c:choose>
                <c:when test="${not empty recipeList[0].MANUAL03}">
                    <div style="display: flex; align-items: center; width: 100%; margin-bottom: 20px;">
                        <!-- 이미지 출력 -->
                        <img id="stepImage" src="/img/step3.png" alt="Step 3" width="150" height="100" style="float: left; margin-right: 10px; border-radius: 10px;" />
            ...
            <c:choose>
                <c:when test="${not empty recipeList[0].MANUAL04}">
                    <div style="display: flex; align-items: center; width: 100%; margin-bottom: 20px;">
                        <!-- 이미지 출력 -->
                        <img id="stepImage" src="/img/step4.png"alt="Step 4" width="150" height="100" style="float: left; margin-right: 10px; border-radius: 10px;" />
            ...
            <c:choose>
                <c:when test="${not empty recipeList[0].MANUAL05}">
                    <div style="display: flex; align-items: center; width: 100%; margin-bottom: 20px;">
                        <!-- 이미지 출력 -->
                        <img id="stepImage" src="/img/step5.png" alt="Step 5" width="150" height="100" style="float: left; margin-right: 10px; border-radius: 10px;" />
            ...
            <c:choose>
                <c:when test="${not empty recipeList[0].MANUAL06}">
                    <div style="display: flex; align-items: center; width: 100%; margin-bottom: 20px;">
                        <!-- 이미지 출력 -->
                        <img id="stepImage" src="/img/step6.png" alt="Step 6" width="150" height="100" style="float: left; margin-right: 10px; border-radius: 10px;" />
