<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <c:set  var="menu_id"            value="${ pdsVo.menu_id         }" /> 
  <c:set  var="startnum"           value="${ pdsVo.pagestartnum    }" /> 
  <c:set  var="endnum"             value="${ pdsVo.pageendnum      }" /> 
  <c:set  var="totalpagecount"     value="${ pdsVo.totalpagecount  }" /> 
