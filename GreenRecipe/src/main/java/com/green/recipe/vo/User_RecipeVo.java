...
public class User_RecipeVo {
     
	private String  USERID;
	private String  RCP_NM ;
	private String  RCP_PARTS_DTLS;
	private byte[]  ATT_FILE_NO_MAIN;
	private Blob    ATT_FILE_NO_MAIN2;
	private byte[]  ATT_FILE_NO_MAIN3;
	...
	public Blob getATT_FILE_NO_MAIN2() {
		return ATT_FILE_NO_MAIN2;
	}
	public void setATT_FILE_NO_MAIN2(Blob aTT_FILE_NO_MAIN2) {
		ATT_FILE_NO_MAIN2 = aTT_FILE_NO_MAIN2;
	}
	public byte[] getATT_FILE_NO_MAIN3() {
		return ATT_FILE_NO_MAIN3;
	}
	public void setATT_FILE_NO_MAIN3(byte[] aTT_FILE_NO_MAIN3) {
		ATT_FILE_NO_MAIN3 = aTT_FILE_NO_MAIN3;
	}
	...
	public String toString() {
		return "User_RecipeVo [USERID=" + USERID + ", RCP_NM=" + RCP_NM + ", RCP_PARTS_DTLS=" + RCP_PARTS_DTLS
				+ ", ATT_FILE_NO_MAIN=" + Arrays.toString(ATT_FILE_NO_MAIN) + ", ATT_FILE_NO_MAIN2=" + ATT_FILE_NO_MAIN2
				+ ", ATT_FILE_NO_MAIN3=" + Arrays.toString(ATT_FILE_NO_MAIN3) + ", HASH_TAG=" + HASH_TAG + ", INFO_CAR="
				+ INFO_CAR + ", INFO_FAT=" + INFO_FAT + ", INFO_NA=" + INFO_NA + ", INFO_PRO=" + INFO_PRO
				+ ", MANUAL01=" + MANUAL01 + ", MANUAL_IMG01=" + Arrays.toString(MANUAL_IMG01) + ", MANUAL02="
				+ MANUAL02 + ", MANUAL_IMG02=" + Arrays.toString(MANUAL_IMG02) + ", MANUAL03=" + MANUAL03
				+ ", MANUAL_IMG03=" + Arrays.toString(MANUAL_IMG03) + ", MANUAL04=" + MANUAL04 + ", MANUAL_IMG04="
				+ Arrays.toString(MANUAL_IMG04) + ", MANUAL05=" + MANUAL05 + ", MANUAL_IMG05="
	...
	public User_RecipeVo(String uSERID, String rCP_NM, String rCP_PARTS_DTLS, byte[] aTT_FILE_NO_MAIN,
			Blob aTT_FILE_NO_MAIN2, byte[] aTT_FILE_NO_MAIN3, String hASH_TAG, int iNFO_CAR, int iNFO_FAT, int iNFO_NA,
			...
			String mANUAL06, byte[] mANUAL_IMG06, String rCP_NA_TIP, int rECIPECOUNT, int iDX) {
		super();
		USERID = uSERID;
		RCP_NM = rCP_NM;
		RCP_PARTS_DTLS = rCP_PARTS_DTLS;
